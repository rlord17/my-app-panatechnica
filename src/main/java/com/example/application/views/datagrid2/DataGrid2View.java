package com.example.application.views.datagrid2;
...
@PageTitle("Data Grid2")
@Route(value = "data-grid2", layout = MainLayout.class)
@AnonymousAllowed
public class DataGrid2View extends Div {
    ...
    public DataGrid2View() {
        addClassName("data-grid2-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
