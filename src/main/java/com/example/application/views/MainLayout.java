...
import com.example.application.views.datagrid2.DataGrid2View;
...
import com.example.application.views.map2.Map2View;
...
public class MainLayout extends AppLayout {
    ...
    private void addDrawerContent() {
        H1 appName = new H1("panatechnica");
    ...
    private SideNav createNavigation() {
        ...
        if (accessChecker.hasAccess(DataGrid2View.class)) {
            nav.addItem(new SideNavItem("Data Grid2", DataGrid2View.class, LineAwesomeIcon.TH_SOLID.create()));
        ...
        if (accessChecker.hasAccess(Map2View.class)) {
            nav.addItem(new SideNavItem("Map2", Map2View.class, LineAwesomeIcon.MAP.create()));
